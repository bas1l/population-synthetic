...
- **GUI config:** `config/gui/v2/menu.yaml` + `config/gui/v2/flows/*.yaml` -- the catalogue and per-flow round-trip YAML for the Flow Runner GUI (`gui_v2`; see [gui_v2 Flow Runner](../development/gui-v2.md))
