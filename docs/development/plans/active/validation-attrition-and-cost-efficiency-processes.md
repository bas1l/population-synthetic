...
- docs/development/decisions/2026-08-20-cost-denominator-and-reconstructed-join-key.md
- docs/development/plans/active/validation-attrition-and-cost-efficiency-processes.md
- docs/development/plans/archived/pipeline-model-method-cost-and-attrition-figures.md
- scripts/analyze/analyze_cost_efficiency.py
- scripts/analyze/analyze_validation_attrition.py
- scripts/analyze/cap_populations.py
- src/population_synthetic/analysis/cost_efficiency/__init__.py
- src/population_synthetic/analysis/cost_efficiency/builder.py
- src/population_synthetic/analysis/cost_efficiency/charts.py
- src/population_synthetic/analysis/cost_efficiency/loader.py
- src/population_synthetic/analysis/cost_efficiency/raw_cost.py
- src/population_synthetic/analysis/population_cap/cap.py
- src/population_synthetic/analysis/utils/attrition_csv.py
- src/population_synthetic/analysis/utils/cost_csv.py
- src/population_synthetic/analysis/utils/tidy_csv.py
- src/population_synthetic/analysis/validation_attrition/__init__.py
- src/population_synthetic/analysis/validation_attrition/builder.py
- src/population_synthetic/analysis/validation_attrition/charts.py
- src/population_synthetic/analysis/validation_attrition/loader.py
- tests/_cost_efficiency_fixtures.py
- tests/_generation_metadata_fixtures.py
- tests/test_analysis_registry.py
- tests/test_cost_csv.py
- tests/test_cost_efficiency_builder.py
- tests/test_cost_efficiency_charts.py
- tests/test_cost_efficiency_loader.py
- tests/test_cost_efficiency_raw_cost.py
- tests/test_population_cap.py
- tests/test_validation_attrition_builder.py
- tests/test_validation_attrition_charts.py
- tests/test_validation_attrition_loader.py
