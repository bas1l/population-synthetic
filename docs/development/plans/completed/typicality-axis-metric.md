...
- docs/development/decisions/2026-08-12-self-contained-typicality-axis.md
- docs/development/persona-realism-judge.md
- docs/development/plans/active/typicality-axis-metric.md
- scripts/analyze/rank_persona_realism.py
- src/population_synthetic/analysis/realism_ranking/builder.py
- src/population_synthetic/analysis/realism_ranking/charts.py
- src/population_synthetic/analysis/utils/ordinal.py
- tests/test_ordinal_stats.py
