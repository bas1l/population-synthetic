...
from population_synth.population.helpers import AGE_GROUP_BOUNDS, VALID_AGE_GROUPS  # noqa: F401
...
#       config/assets/ssb_reference/category_mappings.json["income_source"].
# ---------------------------------------------------------------------------
