...
:func:`population_synth.analysis.llm_metrics.per_run.aggregator.compute_metrics` and persisted as
...
Pipeline:
    1. :func:`load_run_records` (in :mod:`population_synth.analysis.llm_metrics.cross_run.comparison_loader`)
...
:mod:`population_synth.analysis.llm_metrics.cross_run.comparison_stats` and the registry/DTOs/I/O live in
:mod:`population_synth.analysis.llm_metrics.cross_run.comparison_loader`; both are re-exported below so
...
from population_synth.analysis.llm_metrics.cross_run.comparison_loader import (
    METRIC_SPECS,
    METRIC_SPECS_BY_KEY,
    MetricSpec,
    RunRecord,
...
from population_synth.analysis.llm_metrics.cross_run.comparison_stats import (
    _holm,
    _nonempty_groups,
    dunn_posthoc,
    kruskal_test,
...
from population_synth.analysis.llm_metrics.shared import _stats
