...
Assembles, for one country's :class:`~population_synthetic.analysis.model_ranking.loader.ComboPerformance`
    ...
    *skipped* (``(slug, reason)`` pairs from the loader) is recorded in the
    ...
    if len(records) < 2:
        raise ValueError(
            ...
            "Run scripts/analyze/score_fidelity_all.py to produce more comparison reports."
        )
