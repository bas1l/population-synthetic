...
:func:`population_synthetic.analysis.llm_metrics.per_run.aggregator.compute_metrics` and persisted as
...
Pipeline:
    1. :func:`load_run_records` (in :mod:`population_synthetic.analysis.llm_metrics.cross_run.comparison_loader`)
...
from population_synthetic.analysis.llm_metrics.cross_run.comparison_loader import (
    METRIC_SPECS,
    METRIC_SPECS_BY_KEY,
    MetricSpec,
    RunRecord,
