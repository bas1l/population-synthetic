"""
score_fidelity_italy.py -- Compare a pre-mapped synthetic population against a pre-mapped
...
Usage:
    python scripts/analyze/score_fidelity_italy.py \\
...
def main() -> None:
    ...
    if args.output:
        ...
        output_path = analysis_output_dir("fidelity", output_base) / slug / f"{slug}.json"
