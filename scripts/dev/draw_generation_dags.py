...
``src/population_synthetic/population/{sweden,norway,italy}/``.
...
def sweden_spec():
    ...
    return dict(
        ...
        subtitle="src/population_synthetic/population/sweden/  |  SampleService.sample_one  "
...
def norway_spec():
    ...
    return dict(
        ...
        subtitle="src/population_synthetic/population/norway/  |  SSBSampleService.sample_one  "
...
def italy_spec():
    ...
    return dict(
        ...
        subtitle="src/population_synthetic/population/italy/  |  ISTATSampleService.sample_one  "
