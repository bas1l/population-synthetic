"""Dispatcher for database population generation (SCB or SSB).

Accepts a --source argument to select the statistical database, then delegates
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Generate a synthetic population from a statistical database (SCB or SSB)"
    )
    parser.add_argument(
        "--source",
